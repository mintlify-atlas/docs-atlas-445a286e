...
LLM Magic supports multiple AI providers including OpenAI, Anthropic, Google Gemini, Mistral, and OpenRouter. All models are accessed through a unified interface.
